...
import {whaleParseResponse} from './parseResponseType'
...
const buildGqlItem = (method: protobuf.Method, protoInfo: ProtoInfo) => {
  ...
  const res = whaleParseResponse(responseType, protoInfo)
  return `
...
export const buildWhaleGql = (protoInfo: ProtoInfo) => {
